...
namespace TaoAnJu.Util
{
    ...
    public class tb_RoleFunEntity_Op
    {
        private DsConnectionDB _db;

        public tb_RoleFunEntity_Op(DsConnectionDB db)
        {
            _db = db;
        }
        ...
        public virtual tb_RoleFunEntity[] GetAll()
        {
        ...
        public tb_RoleFunEntity[] GetAsArray(string whereSql, string orderBySql)
        {
            int totalRecordCount = -1;
            return GetAsArray(whereSql, orderBySql, 0, int.MaxValue, ref totalRecordCount);
        }

        public virtual tb_RoleFunEntity[] GetAsArray(string whereSql, string orderBySql,
        ...
        {
            string sql = "SELECT * FROM tb_RoleFun";
        ...
        public virtual tb_RoleFunEntity GetByPrimaryKey(int int_RFId)
        {
            string whereSql = "";
            whereSql += "int_RFId=@int_RFId ";

            SqlCommand cmd = CreateGetCommand(whereSql, null);
            AddParameter(cmd, "int_RFId", int_RFId);

            using (SqlDataReader reader = _db.ExecuteReader(cmd))
            {
                tb_RoleFunEntity[] tempArray = MapRecords(reader);
        ...
        /// </summary>
        /// <param name="value">The <see cref="tb_RoleFunEntity"/> object to be inserted.</param>
        public virtual void Insert(tb_RoleFunEntity value)
        {
            string sqlStr = "INSERT INTO tb_RoleFun(";
            ...
            value.int_RFId = Convert.ToInt32(cmd.ExecuteScalar());
        ...
        /// 更新部分字段操作.
        /// </summary>
        /// <param name="value"><see cref="tb_RoleFunEntity"/>
        /// 如果传入的值为空,则不升级该字段</param>
        /// <returns>影响的行数</returns>
        public virtual int Update(tb_RoleFunEntity value)
        {
            string sqlStr = "UPDATE tb_RoleFun SET ";
            if (!value.int_RoleIdNull)
        ...
        /// <summary>
        /// Deletes the specified object from the <c>tb_RoleFunEntity</c> table.
        /// </summary>
        /// <param name="value">The <see cref="YearWorkChild"/> object to delete.</param>
        /// <returns>true if the record was deleted; otherwise, false.</returns>
        public int Delete(tb_RoleFunEntity value)
        {
            return DeleteByPrimaryKey(value.int_RFId);
        }

        public virtual int DeleteByPrimaryKey(int int_RFId)
        {
            string whereSql = "";
            whereSql += "int_RFId=@int_RFId ";
        ...
        /// <summary>
        /// Deletes <c>tb_RoleFunEntity</c> records that match the specified criteria.
        /// </summary>
        ...
        /// to delete <c>tb_RoleFunEntity</c> records that match the specified criteria.
        /// </summary>
        /// <param name="whereSql">The SQL search condition. 
        /// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
        ...
        {
            string sql = "DELETE FROM tb_RoleFun";
            if (null != whereSql && 0 < whereSql.Length)
                sql += " WHERE " + whereSql;
            return _db.CreateCommand(sql);
        }
        ...
        protected tb_RoleFunEntity[] MapRecords(SqlDataReader reader)
        {
            int totalRecordCount = -1;
        ...
        /// <returns>An array of <see cref="YearWorkChild"/> objects.</returns>
        protected virtual tb_RoleFunEntity[] MapRecords(SqlDataReader reader,
            int startIndex, int length, ref int totalRecordCount)
        {
            if (0 > startIndex)
            ...
            while (reader.Read())
            {
                ...
                if (ri > 0 && ri <= length)
                {
                    tb_RoleFunEntity record = new tb_RoleFunEntity();
                    recordList.Add(record); if (!reader.IsDBNull(int_RFIdColumnIndex))
                    ...
                    if (!reader.IsDBNull(int_FunIdColumnIndex))
            ...
            return (tb_RoleFunEntity[])(recordList.ToArray(typeof(tb_RoleFunEntity)));
        ...
        /// <summary>
        /// Converts <see cref="System.Data.DataRow"/> to <see cref="tb_RoleFunEntity"/>.
        /// </summary>
        /// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
        /// <returns>A reference to the <see cref="tb_RoleFunEntity"/> object.</returns>
        protected virtual tb_RoleFunEntity MapRow(DataRow row)
        {
            tb_RoleFunEntity mappedObject = new tb_RoleFunEntity();
        ...
        /// the <c>tb_RoleFunEntity</c> table.
        /// </summary>
        /// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
        protected virtual DataTable CreateDataTable()
        {
            DataTable dataTable = new DataTable();
            dataTable.TableName = "tb_RoleFunEntity";
            DataColumn dataColumn;
    ...
    } // End of  tb_RoleFunEntity_BaseOp class
}  // End of namespace
