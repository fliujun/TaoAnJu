var JqueryDialog = {
    ...
    Open: function (dialogTitle, iframeSrc, iframeWidth, iframeHeight) {
        JqueryDialog.init(dialogTitle, iframeSrc, iframeWidth, iframeHeight, true, true, true, 'auto');
    },
    ...
    init: function (dialogTitle, iframeSrc, iframeWidth, iframeHeight, isSubmitButton, isCancelButton, isDrag, iframeScoll) {
        ...
        //create shadow
        if (typeof ($("#jd_shadow", parent.document.body)[0]) == "undefined" || typeof ($("#jd_shadow", parent.document.body)[0]) == null || $("#jd_shadow", parent.document.body)[0] == null) {
            //前置
    ...
    DisabledSubmit: function () {
        var frm = $("#jd_iframe", parent.document.body);
        frm[0].contentWindow.document.getElementById("jd_submit").disabled = true;
    },
    DisabledCancel: function () {
        var frm = $("#jd_iframe", parent.document.body);
        frm[0].contentWindow.document.getElementById("jd_cancel").disabled = true;
    },
