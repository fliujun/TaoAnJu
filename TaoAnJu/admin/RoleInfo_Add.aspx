<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoleInfo_Add.aspx.cs" Inherits="admin_RoleInfo_Add" %>
    ...
    <div class="content-box" id="BodyDiv">
	    <div class="content-box-content10">
			<table cellspacing="0" cellpadding="0" width="100%" border="0" style="background-color: #Ffffff; width: 100%;">
                ...
                <tr><td align="right" style="width: 80px">角色编号：</td><td><asp:TextBox ID="txt_RoleId" runat="server" Enabled="False" BackColor="#EEEEEE"></asp:TextBox>注：自动生成
                    </td></tr>
                <tr><td align="right" style="width: 80px">角色名称：</td>
                <td><asp:TextBox ID="txt_RoleName" runat="server" MaxLength="50"></asp:TextBox> 
                 </td></tr>
               <tr><td align="right" style="width: 80px">角色描述：</td>
                <td><asp:TextBox ID="txt_RoleDesc" runat="server" MaxLength="50" 
                        BorderStyle="Solid" BorderWidth="1px" TextMode="MultiLine" Width="200px"></asp:TextBox> 
                 </td></tr>
            </table>
        </div>
    </div>
