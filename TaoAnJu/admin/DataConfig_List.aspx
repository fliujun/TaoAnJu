<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataConfig_List.aspx.cs" Inherits="admin_DataConfig_List" %>
...
<body style="margin: 0px">
    ...
    <div id="maintitle"><div id="mainico"></div><div id="maintip"><strong>位置：</strong>数据规范<asp:Literal 
            ID="lit_Type" runat="server"></asp:Literal></div>
        <div>
        <asp:LinkButton ID="btnAdd" runat="server" CssClass="linkbutton" 
            CausesValidation="False" Height="18px" EnableViewState="False">添加</asp:LinkButton>&nbsp;
		    ...
		    <asp:GridView ID="GridView1" runat="server" 
                ...
                <Columns>
                    <asp:TemplateField>
                     ...
                     <asp:BoundField DataField="int_DId" HeaderText="编号" >
                     ...
                     <asp:BoundField DataField="dt_CreateDate" HeaderText="创建时间">
                         <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="150px" Wrap="False" />
                         <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                     </asp:BoundField>
                </Columns>
