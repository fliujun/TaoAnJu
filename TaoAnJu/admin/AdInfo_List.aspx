<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdInfo_List.aspx.cs" Inherits="admin_AdInfo_List" %>
...
<body >
    ...
    <div id="maintitle"><div id="mainico"></div><div id="maintip"><strong>位置：</strong>广告管理</div>
        <div>
    ...
    <div class="content-box role">
        ...
        <div class="searchgrid">
            <table width ="100%">
                <tr><td style="width: 70px" align="right">广告标题：</td><td style="width: 150px">
                    <asp:TextBox ID="txt_AdTitle" runat="server"></asp:TextBox>
                    </td><td style="width: 70px" align="right">广告类型：</td><td>
                    <asp:DropDownList ID="ddl_AdType" runat="server">
                    </asp:DropDownList>
                    </td><td></td></tr>
            </table>
		</div>
		    ...
		    <asp:GridView ID="GridView1" runat="server" 
                ...
                <Columns>
                    <asp:TemplateField>
                     ...
                     <asp:BoundField DataField="int_AId" HeaderText="广告编号" >
                         <ItemStyle HorizontalAlign="center" VerticalAlign="Middle" Wrap="True" />
                         <HeaderStyle HorizontalAlign="center" VerticalAlign="Middle" Width="60px" Wrap="False" />
                     </asp:BoundField>
                     <asp:BoundField DataField="vc_AdTitle" HeaderText="广告标题" >
                         <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                         <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="False" Width="120px"/>
                     </asp:BoundField>
                     <asp:BoundField DataField="vc_AdDesc" HeaderText="广告描述" >
                         <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                         <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="False" />
                     </asp:BoundField>
                     <asp:BoundField DataField="vc_AdPicFile" HeaderText="广告图片" >
                         <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                         <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="False" Width="80px"/>
                     </asp:BoundField>
                     <asp:BoundField DataField="vc_AdLink" HeaderText="广告链接" >
                         <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                         <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" Wrap="False" Width="120px"/>
                     </asp:BoundField>
                     <asp:BoundField DataField="vc_AdType" HeaderText="广告类型" >
